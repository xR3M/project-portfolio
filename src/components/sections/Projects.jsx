      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                <h3 className="text-xl font-bold mb-2"> 3D City Model of Mallorca, Spain Using QGIS & Blender</h3>
                <p className="text-gray-400 mb-4">
                Built a geospatially accurate 3D model of Mallorca by integrating elevation, building, and road network data using QGIS and Blender — showcasing the potential of open-source GIS tools for city modeling and visualization.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                    {["Blender", "QGIS"].map((tech, key) => (
                    <span
                        key={key}
